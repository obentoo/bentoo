...
# version in order to minimize the frequency of disruptive changes.
#
...
FIRMWARE_ABI_VERSION="11.0.0_rc0"
EDK2_OVMF_VERSION="202602"
...
pkg_postinst() {
	...
	if use pin-upstream-blobs && ver_replacing -lt ${FIRMWARE_ABI_VERSION}; then
		...
		if has_version 'sys-firmware/edk2'; then
