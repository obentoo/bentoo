...
if [[ ${PV} == *9999* ]]; then
	...
	# bumped to latest main (1.1.1 upstream tag references an older commit, but
	# AddonManager is developed in a separate repo with its own release cadence).
	ADDONMGR_COMMIT="bfa02b475af7174cb576d2c7eb549420f2683b04"
	SRC_URI="
