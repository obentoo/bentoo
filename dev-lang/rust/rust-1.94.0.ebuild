...
src_prepare() {
	# NOTE: rust-patches tarball is not yet available for this version.
	# When rust-patches-1.94.0.tar.bz2 becomes available, re-add it to
	# SRC_URI and restore the PATCHES line below:
	# PATCHES=( "${WORKDIR}/rust-patches-${RUST_PATCH_VER}/" )
	PATCHES=()
