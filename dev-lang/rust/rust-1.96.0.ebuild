...
# bentoo: the stable rust-patches-${PV} tarball has not been released upstream
# yet; pin the beta snapshot patchset until the stable tag lands, then drop this.
RUST_PATCH_VER=1.96.0_beta20260421
