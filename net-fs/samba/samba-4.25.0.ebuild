...
# BENTOO-DIVERGENCE: KEYWORDS - keyworded, where ::gentoo's newest is not. This
# is ::gentoo's samba-4.25.0_rc2 ebuild verbatim, renamed to the final 4.25.0;
# the ebuild itself sets KEYWORDS only when PV has no _rc suffix, so the rename
# is the whole difference. Temporary mirror (2026-09-25): remove it once
# ::gentoo ships >=net-fs/samba-4.25.0, see its .autoupdate record.
