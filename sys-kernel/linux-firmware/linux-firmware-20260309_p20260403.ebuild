...
MY_COMMIT="583d336ee7c2a15fd9e92c223b147d30737ec04f"
...
if [[ ${PV} == 99999999* ]]; then
	...
	if [[ -n "${MY_COMMIT}" ]]; then
		SRC_URI="https://gitlab.com/api/v4/projects/kernel-firmware%2Flinux-firmware/repository/archive.tar.bz2?sha=${MY_COMMIT} -> ${P}.tar.bz2"
