...
SRC_URI="
	amd64? (
		!rocm? ( https://github.com/ollama/ollama/releases/download/v${PV/_/-}/ollama-linux-amd64.tgz -> ${P}-amd64.tgz )
		rocm? ( https://github.com/ollama/ollama/releases/download/v${PV/_/-}/ollama-linux-amd64-rocm.tgz -> ${P}-rocm.tgz )
	)
	arm64? ( https://github.com/ollama/ollama/releases/download/v${PV/_/-}/ollama-linux-arm64.tgz -> ${P}-arm64.tgz )
"
