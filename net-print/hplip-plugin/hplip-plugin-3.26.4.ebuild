...
# openprinting.org does not yet mirror 3.26.4; HP publishes on developers.hp.com
# with a date-specific path segment that cannot be derived from ${PV}.
SRC_URI="https://developers.hp.com/sites/default/files/2026-05/hplip-${PV}-plugin.run"
S="${WORKDIR}"
